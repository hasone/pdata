...
public class RandomUtil {
     ...
     * 鍙栧緱闅忔満瀛楃涓�
     * @param count 闅忔満瀛楃闀垮害
     * @param start 闅忔満瀛楃鏁扮粍鐨勮捣濮嬩綅缃�
     * @param end   闅忔満瀛楃鏁扮粍鐨勬湯灏句綅缃�
     * @param letters 鏄惁鍙寘鍚瓧姣�
     * @param numbers 鏄惁鍙寘鍚暟瀛�
     * @param chars 闅忔満閫夊彇鐨勫瓧绗︽暟缁勶紝濡傛灉涓虹┖锛屽垯涓烘墍鏈夊瓧绗﹂泦
     * @param random 闅忔満鏁扮敓鎴愬櫒
     * @return
     */
