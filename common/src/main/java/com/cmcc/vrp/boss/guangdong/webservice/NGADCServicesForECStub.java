...
public class NGADCServicesForECStub extends org.apache.axis.client.Stub implements NGADCServiceForEC {
    ...
    public NGADCServicesForECStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        cls = com.cmcc.vrp.boss.guangdong.webservice.NGEC.class;
        ...
        cachedSerQNames.add(qName);
        cls = com.cmcc.vrp.boss.guangdong.webservice.Response.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    private static void _initOperationDesc1() {
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://adc.ecinterface/", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://adc.ecinterface/", "NGEC"), com.cmcc.vrp.boss.guangdong.webservice.NGEC.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://adc.ecinterface/", "NGEC"));
        oper.setReturnClass(com.cmcc.vrp.boss.guangdong.webservice.NGEC.class);
     ...
     */
    public com.cmcc.vrp.boss.guangdong.webservice.NGEC adcServices(com.cmcc.vrp.boss.guangdong.webservice.NGEC request) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                try {
                    return (com.cmcc.vrp.boss.guangdong.webservice.NGEC) _resp;
                } catch (Exception _exception) {
                    return (com.cmcc.vrp.boss.guangdong.webservice.NGEC) org.apache.axis.utils.JavaUtils.convert(_resp, com.cmcc.vrp.boss.guangdong.webservice.NGEC.class);
                }
            }
