...
import com.cmcc.vrp.boss.guangdongzc.model.GdBody;
import com.cmcc.vrp.boss.guangdongzc.model.GdFeatrue;
import com.cmcc.vrp.boss.guangdongzc.model.GdMember;
import com.cmcc.vrp.boss.guangdongzc.model.GdRespBody;
import com.cmcc.vrp.boss.guangdongzc.model.GdRespMember;
import com.cmcc.vrp.boss.guangdongzc.model.GdReturnCode;
import com.cmcc.vrp.boss.guangdongzc.model.GdService1;
import com.cmcc.vrp.boss.guangdongzc.model.GdService2;
import com.cmcc.vrp.boss.guangdongzc.model.MemberShipRequest;
import com.cmcc.vrp.boss.guangdongzc.model.MemberShipResponse;
import com.cmcc.vrp.boss.guangdongzc.model.PrdList1;
import com.cmcc.vrp.boss.guangdongzc.model.PrdList2;
import com.cmcc.vrp.boss.guangdongzc.model.UserInfoMap;
...
import com.cmcc.vrp.boss.guangdongzc.webservice.Response;
...
public class GdWheelBossServiceImpl implements BossService {

    private static final Logger LOGGER = LoggerFactory.getLogger(GdWheelBossServiceImpl.class);
    ...
    private GdMember buildMemer(String mobile, SupplierProduct sPrdouct, boolean newAdd) {
        ...
        member.setPrdList2(buildList2(sPrdouct, newAdd));
     ...
     * @return
     */
    private PrdList2 buildList2(SupplierProduct sPrdouct, boolean newAdd) {
        PrdList2 list2 = new PrdList2();
        String featrue = sPrdouct.getFeature();
        String size = String.valueOf(SizeUnits.KB.toMB(sPrdouct.getSize()));
        Gson gson = new Gson();
