...
public class ADCServiceForECLocator extends org.apache.axis.client.Service implements ADCServiceForEC {
    ...
    public com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServiceForEC getNGADCServicesForEC(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServicesForECStub _stub 
                = new com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServicesForECStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServiceForEC.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServicesForECStub _stub 
                    = new com.cmcc.vrp.boss.guangdongzc.webservice.NGADCServicesForECStub(new java.net.URL(NGADCServicesForEC_address), this);
                _stub.setPortName(getNGADCServicesForECWSDDServiceName());
                return _stub;
            }
        } catch (Throwable t) {
