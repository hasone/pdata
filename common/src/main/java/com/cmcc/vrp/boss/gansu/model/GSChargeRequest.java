...
public class GSChargeRequest {
    ...
    private GSChargeRequestServiceContent serviceContent;
    ...
    public GSChargeRequestServiceContent getServiceContent() {
        return serviceContent;
    }

    public void setServiceContent(GSChargeRequestServiceContent serviceContent) {
