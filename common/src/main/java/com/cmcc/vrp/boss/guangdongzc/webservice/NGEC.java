...
public class NGEC implements java.io.Serializable {
    ...
    private com.cmcc.vrp.boss.guangdongzc.webservice.Response response;
    ...
    public NGEC(
        ...
        String ECUserPwd,
        String processTime,
        com.cmcc.vrp.boss.guangdongzc.webservice.Response response,
        String svcCont) {
     ...
     * @return response
     */
    public com.cmcc.vrp.boss.guangdongzc.webservice.Response getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(com.cmcc.vrp.boss.guangdongzc.webservice.Response response) {
        this.response = response;
    }
