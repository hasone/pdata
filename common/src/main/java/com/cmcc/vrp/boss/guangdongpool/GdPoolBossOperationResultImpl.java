 ...
 */
public class GdPoolBossOperationResultImpl extends AbstractBossOperationResultImpl {
    private MemberOrderResponse memberOrderResponse;

    public GdPoolBossOperationResultImpl(MemberOrderResponse memberOrderResponse) {
    ...
    public GdPoolBossOperationResultImpl(ReturnInfo returnInfo) {
