...
import com.cmcc.vrp.boss.guangdongcard.enums.ActionCode;
import com.cmcc.vrp.boss.guangdongcard.enums.CustType;
import com.cmcc.vrp.boss.guangdongcard.enums.DealKind;
import com.cmcc.vrp.boss.guangdongcard.enums.EffType;
import com.cmcc.vrp.boss.guangdongcard.enums.MemberOptType;
import com.cmcc.vrp.boss.guangdongcard.enums.PayFlag;
import com.cmcc.vrp.boss.guangdongcard.enums.ProductOptType;
import com.cmcc.vrp.boss.guangdongcard.model.CustInfo;
import com.cmcc.vrp.boss.guangdongcard.model.Member;
import com.cmcc.vrp.boss.guangdongcard.model.MemberOrderRequest;
import com.cmcc.vrp.boss.guangdongcard.model.Product;
import com.cmcc.vrp.boss.guangdongcard.model.Service;
import com.cmcc.vrp.boss.guangdongcard.model.User;
import com.cmcc.vrp.boss.guangdongcard.wsdl.AdcSiRequest;
import com.cmcc.vrp.boss.guangdongcard.wsdl.ObjectFactory;
...
public class AdcSiRequestFactory {
    ...
    public AdcSiRequest build(String custId, String ecCode, String ecPrdCode,
            String syAppCode, String mobile, GdPrdInfo gdPrdInfo, boolean testFlag) {
    ...
    private String buildSvcCont(String mobile, String custId, String ecCode, String ecPrdCode,
            GdPrdInfo gdPrdInfo, String syAppCode) {
        MemberOrderRequest mor = new MemberOrderRequest();
        mor.setCustInfo(buildCustInfo(mobile, custId, ecCode, ecPrdCode, gdPrdInfo, syAppCode));
    ...
    private CustInfo buildCustInfo(String mobile, String custId, String ecCode, String ecPrdCode,
        ...
        custInfo.setUser(buildUser(mobile, ecPrdCode,  gdPrdInfo, syAppCode));

        return custInfo;
    }

    private User buildUser(String mobile, String ecPrdCode, GdPrdInfo gdPrdInfo, String syAppCode) {
        User user = new User();
        user.setProductCode(gdPrdInfo.getUserProductCode());
        user.setEcPrdCode(ecPrdCode);
        user.setSyAppCode(syAppCode);
        user.setMember(buildMember(mobile, gdPrdInfo));

        return user;
    }

    private Member buildMember(String mobile, GdPrdInfo gdPrdInfo) {
