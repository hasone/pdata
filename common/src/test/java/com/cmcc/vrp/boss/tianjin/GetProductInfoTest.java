...
public class GetProductInfoTest {
    @InjectMocks
    GetProductInfo bossService = new GetProductInfo();
    ...
    public void testGetUrlID() {
        String mString = "{\"respCode\":\"0\",\"respDesc\":\"ok\",\"result\":{\"SVC_CONTENT\":[{\"ACCT_ID\":\"1116031607212537\"," 
                + "\"ACCT_NEW_BALANCE\":\"100\",\"PRODUCT_ID\":\"0\",\"REMOVE_TAG\":\"0\"," 
                ...
                + "\"TRADE_ID\":\"1117021431645879\",\"TRADE_TYPE_CODE\":\"3166\",\"USER_ID\":\"100\",\"X_CLIENT_IP\":\"\"," 
        ...
        PowerMockito.when(HttpUtils.post(Mockito.anyString(), Mockito.anyString(), Mockito.anyString()))
            .thenReturn(mString);
        Assert.assertEquals("100", bossService.getUrlID("0", "0"));
    }
}
