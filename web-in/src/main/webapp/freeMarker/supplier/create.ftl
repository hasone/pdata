...
<head>
    ...
    <title>流量平台-新建供应商</title>
    <meta name="keywords" content="流量平台 新建供应商"/>
    <meta name="description" content="流量平台 新建供应商"/>
...
<div class="main-container">
    ...
    <form class="form-horizontal" action="${contextPath}/manage/supplier/save.html" method="post"
                ...
                <div class="row form">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group">
                            <label>供应商：</label>
                            <input type="text" name="name" id="name" class='hasPrompt' maxLength="64"
                                   required/>
                        ...
                        <div class="form-group">
                            <label>供应商指纹：</label>
                            <input type="text" name="fingerprint" id="fingerprint" class='hasPrompt' maxLength="200" 
                                   required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group btn-group-sm">
                                <input style="width: 0; height: 0; opacity: 0" name="isQueryChargeResult" id="isQueryChargeResult" required>
                                <button type="button" class="btn btn-default" style="width: 300px">状态</button>
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                    <span class="caret"></span>
                        ...
                        <div class="form-group">
                            <label>付款方式：</label>
                            <input type="text" name="payType" id="payType" class='hasPrompt' maxLength="32"/>
                        </div>
                        
                        <div class="form-group">
                            <label>合同编号：</label>
                            <input type="text" name="contractCode" id="contractCode" class='hasPrompt' maxLength="32"/>
                        </div>
