    ...
    <div class="tools row ">
        ...
        <div class="col-sm-10 dataTables_filter text-right">
            <div id="searchForm" class="form-inline searchForm" id="table_validate">
                ...
                <input type="hidden" class="searchItem" name="ruleId" value="${ruleId}" id="ruleId">
...
<script>
    ...
    var columns = [{name: "enterpriseName", text: "企业名称", tip: true},
        ...
        {name: "createTime", text: "中奖时间", format: "DateTimeFormat"},
        {name: "operateTime", text: "充值时间", format: "DateTimeFormat"},
        {name: "status", text: "状态", format: statusFormat},
        {name: "op", text: "操作", format: buttonsFormat}];


    var action = "${contextPath}/manage/entRedpacket/searchRecord.html?${_csrf.parameterName}=${_csrf.token}";
