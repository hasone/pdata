...
<head>
    ...
    <title>统一流量平台-添加黑名单企业</title>
    <meta name="keywords" content="统一流量平台 添加黑名单企业"/>
    <meta name="description" content="统一流量平台 添加黑名单企业"/>
...
<div class="main-container">
            ...
            <div class="form">
                <form id="dataForm">
                    <div class="form-group form-group-sm form-inline">
                        <label>企业名称</label>
                        <input type="text" class="form-control" id="eName" name="eName" maxlength="64">
                    ...
                    <div class="form-group form-group-sm form-inline">
                        ...
                        <span class="error-tip" id="keyword-error"></span>
                        <p class="prompt">请输入对应的关键词，例“移动通信”</p>
                    </div>
                    <div class="form-group form-group-sm form-inline">
                        <label>已添加关键词</label>
                        <span id="added-keyword"></span>
    ...
    <div class="mt-30 text-center">
        <a class="btn btn-sm btn-warning dialog-btn" id="submit-btn">确 定</a>
    </div>
</div>
...
<script>
    ...
    function addItem() {
        ...
        if (!(params.eName || params.keyword)) {
            ...
            var url = "${contextPath}/manage/blacklist/save.html";
