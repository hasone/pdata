...
<head>
    ...
    <title>流量平台-兑换报表</title>
    <meta name="keywords" content="流量平台 兑换报表"/>
    <meta name="description" content="流量平台 兑换报表"/>
...
<script>
    ...
    var columns = [{name: "ownerMobile", text: "手机号"},
        {name: "mobile", text: "充值手机号"},
        {name: "productName", text: "产品名称"},
        {name: "productSize", text: "产品大小", format: productSizeFormat},
        {name: "count", text: "消耗流量币"},
    ...
    var action = "${contextPath}/manage/membership/searchExchangeList.html?${_csrf.parameterName}=${_csrf.token}";
    ...
    function createFile() {
        ...
        window.open(
                "${contextPath}/manage/membership/createExchangeListFile.html?mobile=" + mobile + "&&nickname=" + nickname
