...
<div class="main-container">
    ...
    <form action="${contextPath}/manage/product/save.html" method="POST" name="enterprisesForm" id="table_validate">
            ...
            <div class="tile-content">
                <div class="row form">
                    ...
                    <#--<span style="color:red" id="tip_name" ></span><br/>-->
                        <div class="prompt1">产品名称由汉字、英文字符及数字组成，长度不超过32个字符</div>
                    </div>
                    ...
                    <#--<span style="color:red" id="tip_productCode" ></span><br/>-->
                        <div class="prompt2">产品编码由英文字符、数字及下划线组成，长度不超过20个字符</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="prompt3">流量包大小由数字组成,长度不超过8字符。</div>
                    </div>
                    <div class="form-group">
                        <label>产品价格:</label>
                        <input type="text" name="price" id="price" value="${(product.price)!}" class='hasPromt'
                               onfocus="$('#isModifyChanged').val('true')"/>
                        <span>分            </span>
                        <div class="prompt3">产品价格由数字组成，单位为分，长度不超过12个字符。</div>
                    </div>
                    <div class="form-group">
                        <label>状态：</label>
    ...
    function check() {
        $("#table_validate").packValidate({
            ...
            messages: {
                name: {
                    required: "产品名称不能为空!",
                    maxlength: "字符长度最大为32位!",
                    remote: "该产品名称已存在!"
                },
                productCode: {
                    required: "产品编码不能为空!",
                    maxlength: "字符长度最大为12位!",
                    remote: "该产品编码已存在!"
                },
                productSize: {
                    required: "流量包大小不能为空!",
