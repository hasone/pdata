    ...
    <div class="tools row">
        ...
        <div class="col-sm-2">
            ...
            <a href="${contextPath}/manage/mdrc/active/create.html" class="btn btn-sm btn-danger">
                <i class="fa fa-plus mr-5"></i>新增激活申请
            </a>-->
        </div>
...
<script>
    ...
    var buttonsFormat = function (value, column, row) {
    	return ["<a class='btn-icon mr-5 icon-detail' href='${contextPath}/manage/approval/mdrcActiveApprovalDetail.html?id=" + row.id +"&canOperate=0'>详情</a>"];    				
    ...
    var columns = [
        ...
        {name: "createTime", text: "申请时间", format: dateFormator}
    ];
