...
<head>
    ...
    <meta name="keywords" content="流量平台 企业流控额度追加"/>
    <meta name="description" content="流量平台 企业流控额度追加"/>
...
<div class="main-container">
    ...
    <form action="${contextPath}/manage/entFlowControl/saveEntFlowControlAddition.html"
            ...
            <div class="tile-content">
                <div class="row form">
                    ...
                    <div class="form-group">
                        <label>日上限金额:</label>
                        <input type="text" id="countAddition" name="countAddition" maxlength="8" required/>(元)
                        <span class="prompt">请填写1-99999999的正整数，日额度追加金额仅追加当天有效</span>
...
<script>
    require(["common", "bootstrap"], function () {
    	$("#countAddition").on("input", function () {
            var val = $(this).val();
            if (val == 0) {
            	val = "";
            }
