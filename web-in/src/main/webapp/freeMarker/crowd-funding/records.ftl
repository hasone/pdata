...
<div class="main-container">
    ...
    <div class="tools row ">
        <div class="col-sm-1">
            <a href="">
                <a class="btn btn-primary btn-sm btn-icon icon-back"
                   onclick="history.go(-1)">返回</a>
                <!--<button class="btn btn-danger"><i class="fa fa-plus mr-5"></i>导出全部中奖记录</button>-->
            </a>
        </div>

        <div class="col-sm-11 dataTables_filter text-right">
                ...
                <div class="form-group mr-10">
                    ...
                    <div class="btn-group btn-group-sm">
                        <input style="width: 0; font-size: 0; height: 0; opacity: 0" class="form-control searchItem"
                               name="payResult" value="0,1,2,3,4,5,6">
                        ...
                        <ul class="dropdown-menu">
                            <li data-value="0,1,2,3,4,5,6"><a href="#">全部</a></li>
                            <li data-value="0"><a href="#">未支付</a></li>
                            <li data-value="1"><a href="#">支付中</a></li>
                            <li data-value="2"><a href="#">支付成功</a></li>
                            <li data-value="3"><a href="#">支付失败</a></li>
                            <li data-value="4"><a href="#">退款成功</a></li>
                            <li data-value="5"><a href="#">退款失败</a></li>
                            <li data-value="6"><a href="#">未知异常</a></li>
                        </ul>
                    </div>
                </div>                
                ...
                <div class="form-group mr-10">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-value="1"><a href="#">待领取</a></li>
        ...
        <div class="form-inline ml-15 mt-45">
...
<script>
    ...
    var payResultFormat = function (value, column, row) {
    	if (row.payResult == 0) {
            return "未支付";
        }
    ...
    var columns = [{name: "ownMobile", text: "手机号码"},
        ...
        {name: "paymentTime", text: "支付时间", format: dateFormator},
        {name: "payResult", text: "支付状态", format: payResultFormat},        
    ...
    var action = "${contextPath}/manage/crowdFunding/searchRecords.html?${_csrf.parameterName}=${_csrf.token}";
    ...
    function createFile(obj) {
        ...
        var payResult = $("input[name='payResult']").val();
        var productName = document.getElementById('productName').value;
        var mobile = document.getElementById('mobile').value;
        location.href = "${contextPath}/manage/crowdFunding/downloadWinRecords.html?activityId=${activityId!}&status="+status+
            "&mobile="+mobile+"&productName="+productName+"&payResult="+payResult;
    }
