...
<head>
    ...
    <title>统一流量平台-新建流量众筹</title>
    <meta name="keywords" content="统一流量平台 新建流量众筹"/>
    <meta name="description" content="统一流量平台 新建流量众筹"/>
        ...
        <div class="tile-content">
            <form class="row form" id="dataForm">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-sm enterprise-select">
                            ...
                            <button type="button" class="btn btn-default btn-select" style="width: 299px">请选择</button>
                    ...
                    <div class="form-group">
                        ...
                        <img id="bannerImage" style="max-width: 326px; max-height: 151px;" src=""/>
                        <div class="file-box banner-btn" style="vertical-align: bottom;">
                            <a href="javascript:void(0)" >上传图片</a>
                            <input type="file" class="file-helper imge-check " id="banner"
                    ...
                    <div class="form-group">
                        ...
                        <img id="logoImage" style="max-width: 160px; max-height: 160px;" src=""/>
                        <div class="file-box" style="vertical-align: bottom;">
                            <a href="javascript:void(0)">上传图片</a>
                            <input type="file" class="file-helper imge-check " id="logo"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>活动时间：</label>
                            <span id="activeTime" style="display: inline-block;">
                                <input type="text" name="startTime" id="startTime" value="" readonly="readonly" required>&nbsp;至&nbsp;
                                <input type="text" id="endTime" name="endTime" value="" readonly="readonly" >
                                <label class="error error-tip" id="time_tip" style="width: 0;"></label>
                            </span>
                    </div>
                    <div class="form-group">
                        <label>充值时间：</label>
                        ...
                        <#--
                            <span class="input-checkbox ml-30">
                                <input type="radio" value="2" name="chargeType" id="immediate_2" class="hidden">
                    ...
                    <div class="form-group">
                        <label>目标人数：</label>
                        <input type="text" name="targetCount" id="targetCount" maxlength="8" class="mobileOnly" required
                               data-bind="value: targetCount, valueUpdate: 'afterkeydown'">
                    </div>
                    <div class="form-group">
                        <label style="vertical-align: top;">活动规则：</label>
                        <textarea rows="10" cols="100" id="rules" name="rules" maxlength="300" placeholder="活动规则说明……"
                                  required></textarea>
                        <!--<input name="rules" style="width: 0; height: 0;padding: 0; opacity: 0;" required>-->
                    ...
                    <div class="form-group">
                        ...
                        <span class="file-box">
                            ...
                            <input name="verify" style="width: 0; height: 0;padding: 0; opacity: 0;">
                    ...
                    <div class="form-group">
                        <label>审核附件：</label>
                        <div class="file-box">
                            <input type="text" class="file-text" value="" style="width: 284px;">
...
<#--
                    ...
                    <div id="upload" hidden>
                         <div class="file-box">
                             <input type="text" id="phones" name="phones" value="" readOnly="true" class="file-text" style="width: 268px;">
...
<#--
    ...
    function listeners() {
    	...
    	$(".enterprise-select a").on("click", function () {
    		...
    		if(lastEntId == ''){
    			...
    			//切换企业,清空奖品信息
    			//console.log("lastEntId..."+lastEntId);
    			//console.log("entId..."+entId);
    			if(lastEntId != entId){
    ...
    function saveData() {
        ...
        if (valid) {
            ...
            trs.each(function(id){
                ...
                //获取折扣信息
                var discount = $(this).find(".count").val()
                item["discount"] = discount * 10;
            ...
            var formData = {
                ...
                queryurl:$("#head").val() + '://' + $("#callbackUrl").val()
            };
            ...
            $.ajaxFileUpload({
                ...
                data: formData,
                url: "${contextPath}/manage/crowdFunding/saveAjax.html?${_csrf.parameterName}=${_csrf.token}",
                dataType: 'json',
    ...
    function appendToYY(data) {
        ...
        var tr = $('<tr data-key="' + time + '" data-id="' + data["id"] + '" data-size="' + data["productSize"] + '" data-type="' + data["type"] + '" data-name="' + data["name"] +'">' +
                '<td>' + data["name"] + '</td>'+
                '<td>' + data["productCode"] + '</td>' +
                '<td>' + productSize + '</td>' +
                '<td>' + price + '</td>' +
                '<td>' + data["ownershipRegion"] + '</td>' +
                '<td>' + data["roamingRegion"] + '<input type="hidden" class="count" value="10"></td>' +
    ...
    function initFormValidate() {
        $("#dataForm").validate({
            ...
            //    if (element.parent().find(".promote").length || element.parent().parent().find(".promote").length) {
            //        element.after(error);
            //    } else {
            //        element.closest(".form-group").append(error);
            //    }
