...
<div class="section client">
    <div id="accordion" class="cm-accordion-menu black">
        ...
        <div class="mask introduction-wrap" style="top: 160px;">
            ...
            <div class="content" style="width: 200px;">管理员对提交的众筹活动进行审批，审批通过后活动方可正常进行</div>
        </div>
    </div>
</div>
...
<div class="desktop-wrap client">
    <div class="main-container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-indent text-center table-bordered-noheader mb-0">
                            ...
                            <tr>
                                ...
                                <th>企业编码</th>
                                <th>所属地区</th>
                                <th width="204px" style="overflow: visible;position: relative;">审批操作
                                    <div class="mask introduction-wrap" style="top: -105px;border-collapse: separate;">
                                        <div class="content" style="height: 5.5rem;">管理员审批通过，<br>则活动上架成功</div>
        ...
        <a class="mask btn-mode btn-known" style="top: 10%; display: block;">下一步</a>
    </div>
</div>
