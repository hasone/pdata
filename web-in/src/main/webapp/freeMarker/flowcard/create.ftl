...
<div class="main-container">
                        ...
                        <table class="table table-bordered text-center award-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="feeAccount" class="form-group" style="display:none">
    ...
    <div class="tile mt-30">
        ...
        <div class="tile-content">
            <div class="form-group">
                <label style="width: 110px;">被赠送人号码：</label>
                <input type="text" id="phones" name="phones" value="" readOnly="true" required>
                    <span class="file-box">
                ...
                <p class="red text-left" style="padding-left: 112px;" id="modal_error_msg"></p>
            </div>
        </div>
    </div>
    ...
    function selectedProduct(id) {
        ...
        if (type == "M") {
            ...
            if (product.type == '1') {
                ...
                $("#feeAccount").show();
                $("#cmProdPrice").html('-');
                $("#feeAccount").children("input").on("input", function () {
                    $("#cmProdPrice").html(pricefun($(this).val() * 100.0))
                });
            } else {
                $("#flowAccount").hide();
                $("#packageAccount").show();
                ...
                if (cqFlag == 0) {
                    ...
                    $("#cmProdPrice").html(product.count);
                }
            }
    ...
    require(["common", "bootstrap", "daterangepicker", "page/list", "upload"], function () {
        ...
        $("#save-btn").on("click", function () {
            if ($("#dataForm").validate().form()) {
                ...
                //传递话费、流量池产品大小
                var product = productmap[cmProdId];
                if (product.type == '1') {
                    var prdSize = $("#cmProdSize_flowaccount").val();
                    $("#prdSize").val(prdSize);
                } else if (product.type == '3') {
                    var prdSize = $("#cmProdSize_feeAccount").val();
