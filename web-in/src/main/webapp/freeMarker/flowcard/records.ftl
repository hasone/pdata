            ...
            <div id="searchForm" class="form-inline searchForm" id="table_validate">
                ...
                <div class="form-group mr-10">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <ul class="dropdown-menu">
                            <li data-value=""><a href="#">全部</a></li>
                            <li data-value="0"><a href="#">未使用</a></li>
...
<script>
    ...
    var columns = [{name: "ownMobile", text: "被赠送人手机号", tip: true},
        {name: "chargeMobile", text: "充值手机号"},
    ...
    var action = "${contextPath}/manage/flowcard/searchRecords.html?${_csrf.parameterName}=${_csrf.token}";
