...
<head>
    ...
    <meta name="keywords" content="流量平台 创建职位"/>
    <meta name="description" content="流量平台 创建职位"/>
...
<div class="main-container">
    ...
    <form action="${contextPath}/manage/manager/saveManager.html" method="post" name="adminForm" id="table_validate">
                ...
                <div class="row form">
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-sm">
                            <input style="width: 0; height: 0; opacity: 0" name="roleId" id="roleId" required>
                            <button type="button" class="btn btn-default" style="width:225px">选择角色</button>
                            ...
                            <#if roles??>
                                <#list roles as role>
                                    <li data-value="${(role.roleId)! }"><a
                                            onclick="showRole('${(role.name)!}')">${role.name!}</a></li>
                                </#list>
                            </#if>
                            </ul>
                        </div>
                    ...
                    <div class="form-group" id="user_select">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <button type="button" class="btn btn-default" style="width:225px">选择名称</button>
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                <span class="caret"></span>
                                <span class="sr-only">Toggle Dropdown</span>
                    ...
                    <div class="form-group" id="user_define" style="display:none">
                        <label>职位名称：</label>
                        <input type="text" name="name_define" id="name_define" class="hasPrompt" maxLength="64" style="display:none"
                               required/>
                        <span id="roleName2"></span>
