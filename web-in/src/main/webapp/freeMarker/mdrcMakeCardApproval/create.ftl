...
<head>
    ...
    <title>流量礼品卡平台-新增制卡申请</title>
    <meta name="keywords" content="流量礼品卡平台 新增制卡申请"/>
    <meta name="description" content="流量礼品卡平台 新增制卡申请"/>
    ...
    <div class="tile mt-30">
        ...
        <div class="tile-content">
            <div class="row form">
                ...
                <div class="form-group">
                    <label>制卡数量：</label>
                    <input type="text" name="amount" id="amount" class="mobileOnly"/>
                    <div class="prompt">请输入${minCardNum!}-${maxCardNum}之间的数值</div>
                </div>
                
                <div class="form-group">
                    <label>卡名称：</label>
                    <input type="text" name="configName" id="configName" maxlength="64"/>
                ...
                <div class="form-group">
                    <label>有效期：</label>
                        <span id="validTime">
                            <input style="width: 160px" type="text" name="startTime" id="startTime" readOnly="readOnly">
                            &nbsp;至&nbsp;
                            <input style="width: 160px" type="text" id="endTime" readOnly="readOnly" name="endTime">
                        </span>
                    <input type="text" style="width:0;height:0;padding: 0; margin: 0;" name="startendTime" id="startendTime">
                </div>

                <div class="form-group">
                    <label>模板选择：</label>
                    <input type="radio" name="templateChoice" value="0"><span class="mr-30">模板库</span>
                    <input type="radio" name="templateChoice" value="1"><span>自定义上传</span>
                </div>

                <div id="templateLib">
                    <div class="form-group">
                        <label>卡面主题：</label>
                        <select id="themeSelect" name="themeSelect" onchange="selectTheme(this.options[this.options.selectedIndex].value)">
                        </select>
                    </div>
                ...
                <div id="customUpload" hidden>
                    ...
                    <div class="form-group">
                        <label>正面预览：</label>
                        <div class="btn-group">
                            <img class="templateFront" src="" style="max-width:360px;"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label>背面预览：</label>
                        <div class="btn-group">
                            <img class="templateBack" src="" style="max-width:360px;"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label>客服电话：</label>
                    <input type="text" name="serviceTel" id="serviceTel" maxlength="20"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="file-box">
                        ...
                        <input type="text" name="qrCodeName" class="file-text" style="width:0; height:0; padding: 0; opacity: 0;">
                    ...
                    <div class="btn-group" style="padding-left: 40.5%;">
                        <img class="qrCode" src="" style="max-width: 160px;"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label>制卡费用：</label>
                    <span class="mr-20" style="color: red;" id="cardFee">￥0.00</span>
                    <input type="checkbox" style="vertical-align: text-bottom;margin-bottom: 2px;" id="isReduce"/>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" style="padding-left: 40.5%;">
                        <img class="certificate" src="" style="max-width:360px;"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="tile mt-30">
        ...
        <div class="tile-content">
            <div class="row form">
                ...
                <div class="form-group">
                    <label>收件人姓名：</label>
                    <input type="text" name="consigneeName" id="consigneeName" maxlength="64"/>
                </div>

                <div class="form-group">
                    <label>收件人手机号码：</label>
                    <input type="text" name="consigneeTel" id="consigneeTel" class="mobileOnly" maxlength="11"/>
                </div>

                <div class="form-group">
                    <label style="vertical-align: top">详细地址：</label>
                    <textarea type="text" name="consigneeAddress" id="consigneeAddress" maxlength="300"></textarea>
                </div>

                <div class="form-group">
                    <label>邮编：</label>
                    <input type="text" name="consigneePostcode" id="consigneePostcode" class="mobileOnly" maxlength = "6"/>
                </div>
            </div>
        </div>
    </div>
...
//            },
    ...
    function doSubmit() {
        ...
        $.ajaxFileUpload({
            ...
            data: formData,
            url: "${contextPath}/manage/mdrc/cardmake/submitAjax.html?${_csrf.parameterName}=${_csrf.token}",
            dataType: 'json',
