...
<div class="main-container">
    ...
    <div class="tile mt-30" style="overflow:auto;">
        ...
        ${(activity.startTime)?datetime} &nbsp;&nbsp;至&nbsp;&nbsp; ${(activity.endTime)?datetime}
            ...
            <label class="control-label">每人每天可玩次数: </label><label>${(activity.maxPlayNumber)!}次</label><br/>
            <label class="control-label">每人可中奖次数: </label><label>${(activity.givedNumber)!}次</label><br/>
            ...
            <label class="control-label">URL: </label><label class="break-block">
    ...
    <div class="tile" style="overflow:auto;">
        ...
        <div class="mt-30">
            <a class="btn btn-sm btn-warning" href="${contextPath}/manage/goldenBall/records.html?id=${activity.id}">查看用户中奖信息</a>
        </div>
