    ...
    <div class="tools row text-right">
        ...
        <div class="col-lg-12 dataTables_filter text-right">
            <div id="searchForm" class="form-inline searchForm" id="table_validate">
                ...
                <div class="form-group form-group-sm">
                    <label for="code">产品模板名称：</label>
                    <input type="text" name="productTemplateName" id="productTemplateName" class="form-control searchItem" autocomplete="off"
                           placeholder="" value=""
                           maxlength="255">
                </div>
...
<script>
    ...
    var columns = [{name: "name", text: "企业名称", tip: true, format: nameFormat},
        ...
        {name: "productTemplateName", text: "产品模板名称", tip: true},
    ...
    function createFile(obj) {
        location.href = "${contextPath}/manage/productTemplate/download.html";
    }
