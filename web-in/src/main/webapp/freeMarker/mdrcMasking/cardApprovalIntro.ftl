...
<div class="section client">
    <div id="accordion" class="cm-accordion-menu black">
        ...
        <div class="mask introduction-wrap" style="top: 160px">
            ...
            <div class="content" style="width: 200px;">平台管理员在制卡审批中对提交的制卡申请进行审批，审批通过后卡数据生成，可进入下载数据，制卡阶段</div>
        </div>
    </div>
</div>
...
<div class="desktop-wrap client">
    <div class="main-container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-indent text-center table-bordered-noheader mb-0">
                            ...
                            <tr>
                                ...
                                <th width="96px" style="overflow: visible;position: relative;">操作
                                    <div class="mask introduction-wrap" style="top: -105px;">
                                        <div class="content" style="display: block; height: 5rem;line-height: 5rem; margin-left: -55px;">制卡人员下载、制卡、邮寄</div>
                            ...
                            <tr>
                                ...
                                <td>1G</td>
                                <td>审批中</td>
                                <td><a href="javascript:void(0);">审批</a></td>
        ...
        <a class="mask btn-mode btn-known" href="${contextPath}/manage/mdrc/masking/cardDownloadIntro.html" style="top: 10%; display: block;">下一步</a>
    </div>
</div>
