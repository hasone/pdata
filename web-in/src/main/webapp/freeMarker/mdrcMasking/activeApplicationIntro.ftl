...
<div class="section client">
    <div id="accordion" class="cm-accordion-menu black">
        ...
        <div class="mask introduction-wrap" style="top: 160px">
            ...
            <div class="content" style="width: 200px;">签收确认后可提交申请，激活成功后卡方可正常使用</div>
        </div>
    </div>
</div>
    ...
    <div class="main-container">
        ...
        <div class="tools row">
            <div class="col-sm-2" style="position: relative;">
                <a href="javascript:void(0);">
                    <button class="btn btn-danger">新增激活申请</button>
                </a>
                <div class="mask introduction-wrap" style="top: -13px; left: 152px; width: 204px;">
                    ...
                    <div class="content text-center" style="height: 5rem; width: 13rem;">新增激活申请</div>
                </div>
            </div>
        ...
        <a class="mask btn-mode btn-known" href="${contextPath}/manage/mdrc/masking/activeApprovalIntro.html" style="top: 10%; display: block;">下一步</a>
    </div>
</div>
