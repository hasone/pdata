...
<div class="section client">
    <div id="accordion" class="cm-accordion-menu black">
        ...
        <div class="mask introduction-wrap" style="top: 160px">
            ...
            <div class="content" style="width: 200px;">当签收到实体卡后，企业在卡数据列表进行卡批次的签收操作，只有签收确认的卡才可进行激活使用</div>
        </div>
    </div>
</div>
...
<div class="desktop-wrap client">
    <div class="main-container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-indent text-center table-bordered-noheader mb-0">
                            ...
                            <tr>
                                ...
                                <th>流量大小</th>
                                <th>状态</th>
                                <th width="182px" style="overflow: visible;position: relative;">操作
                                    <div class="mask introduction-wrap" style="top: -105px;">
                                        <div class="content" style="display: block; height: 5rem;line-height: 5rem; margin-left: -11px;">企业进行签收</div>
                            ...
                            <tr>
                                ...
                                <td>1G</td>
                                <td>新制卡</td>
                                <td><a class="mr-5" href="javascript:void(0);">批次详情</a>
                                    <a href="javascript:void(0);">卡列表</a></td>
                            ...
                            <tr>
                                ...
                                <td>制卡中</td>
                                <td><a class="mr-5" href="javascript:void(0);">批次详情</a>
                                    <a href="javascript:void(0);">卡列表</a><a href="javascript:void(0);">下载失败</a></td>
                            ...
                            <tr>
                                ...
                                <td>2G</td>
                                <td>已邮寄</td>
                                <td><a class="mr-5" href="javascript:void(0);">签收</a>
                                    <a class="mr-5" href="javascript:void(0);">批次详情</a>
                                    <a href="javascript:void(0);">卡列表</a></td>
        ...
        <a class="mask btn-mode btn-known" href="${contextPath}/manage/mdrc/masking/activeApplicationIntro.html" style="top: 10%; display: block;">下一步</a>
    </div>
</div>
