...
<div class="section client">
    <div id="accordion" class="cm-accordion-menu black">
        ...
        <div class="mask introduction-wrap" style="top: 160px">
            ...
            <div class="content" style="width: 200px;">制卡人员在卡数据列表下载卡数据，制卡完成后进行发货邮寄操作</div>
        </div>
    </div>
</div>
...
<div class="desktop-wrap client">
    <div class="main-container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-indent text-center table-bordered-noheader mb-0">
                            ...
                            <tr>
                                ...
                                <th>制卡数量</th>
                                <th>状态</th>
                                <th width="120px" style="overflow: visible;position: relative;">操作
                                    <div class="mask introduction-wrap" style="top: -105px;">
                                        <div class="content" style="display: block; height: 5rem;line-height: 5rem; margin-left: -43px;">制卡人员下载、制卡、邮寄</div>
                            ...
                            <tr>
                                ...
                                <td>1000</td>
                                <td>新制卡</td>
                                <td><a href="javascript:void(0);">下载卡数据</a></td>
                            ...
                            <tr>
                                ...
                                <td>1000</td>
                                <td>制卡中</td>
                                <td><a class="mr-5" href="javascript:void(0);">发货</a><a href="javascript:void(0);">下载失败</a></td>
                            ...
                            <tr>
                                ...
                                <td>1000</td>
                                <td>已发货</td>
                                <td><a href="javascript:void(0);">物流信息</a></td>
        ...
        <a class="mask btn-mode btn-known" href="${contextPath}/manage/mdrc/masking/cardSignIntro.html" style="top: 10%; display: block;">下一步</a>
    </div>
</div>
