...
<div class="main-container">
    ...
    <div class="tools row ">
        <div class="col-sm-2">
            <a href="${contextPath}/manage/goldenegg/create.html">
                <button class="btn btn-sm btn-danger"><i class="fa fa-plus mr-5"></i>新增砸金蛋</button>
            </a>
        </div>
    ...
    var buttonsFormat = function (value, column, row) {
        ...
        if (row.status == 0 || row.status == 7) {
            if(approvalFlag=="true"){
                return ["<a class='btn-icon icon-edit mr-5' href='${contextPath}/manage/goldenegg/edit.html?activityId="+ row.activityId +"'>编辑</a>",
                        "<a class='btn-icon icon-detail mr-5' href='${contextPath}/manage/goldenegg/detail.html?activityId=" + row.activityId + "'>详情</a>",
            ...
            return ["<a class='btn-icon icon-detail mr-5' href='${contextPath}/manage/goldenegg/detail.html?activityId=" + row.activityId + "'>详情</a>"];
        }
    }
...
//        {name: "usedAmount", text: "中奖人数"},
    ...
    var action = "${contextPath}/manage/goldenegg/search.html?${_csrf.parameterName}=${_csrf.token}";
    ...
    function init() {
        $("#sure").on("click", function () {
            ...
            $.ajax({
                ...
                url: "${contextPath}/manage/goldenegg/submitActivityApprovalAjax.html",
                data: {
    ...
    function onShelf(activityId) {
        $.ajax({
            ...
            type: "post",
            url: "${contextPath}/manage/goldenegg/onshelf.html",
            data: {
                activityId: activityId
            },
            dataType: "json", //指定服务器的数据返回类型，
