                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <span id="activeTime" style="display: inline-block">
                            <input type="text" name="startTime" id="startTime">&nbsp;至&nbsp;<input
                                type="text"
                                id="endTime"
                                name="endTime"
                                required>
    ...
    <div class="modal-dialog" style="width: 800px;">
        <div class="modal-content bd-muted">
            ...
            <div class="modal-body" style="padding: 40px 10px;">
                ...
                <div id="product-table" role="table"></div>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
    ...
    function saveData() {
        ...
        <#if allowAllPlatformProduct??  && allowAllPlatformProduct>
            ...
            if (valid) {
                ...
                ajaxData("${contextPath}/manage/lottery/saveAjax.html", {
    ...
    function appendToYY(data) {
        ...
        if (tds.length === 11) {
            ...
            if (data["type"] == "1") {
            	...
            	tds.eq(3).html('<input type="text" class="mobileOnly size">个');
                tds.eq(4).html('-');
            }else {
                var size = sizeFun(data["productSize"]);
                tds.eq(3).html(size);
