...
<#if opinions??>
    ...
    <div class="tile mt-30">
        ...
        <div class="tile-content">
            <div class="row">
                ...
                <#if activityInfo.url??>
                    <div class="form-group">
                        <span class="detail-label">大转盘URL:</span>
                    ...
                    <div class="form-group">
                        <span class="detail-label" style="vertical-align: top;"></span>
                            <span class="detail-value ml-10">
                                <img src="${contextPath}/manage/lottery/qrCode.html?activityId=${activities.activityId!}">
                            </span>
                    </div>
                </#if>
                </div>
    ...
    <div class="mt-30">
        <a class="btn btn-sm btn-warning"
           href="${contextPath}/manage/lottery/records.html?activityId=${activities.activityId!}">查看用户中奖信息</a>
    </div>
</div>
