...
<div class="main-container">
    ...
    <div class="tools row ">
        <div class="col-sm-2">
            <a href="${contextPath}/manage/lottery/create.html?${_csrf.parameterName}=${_csrf.token}">
    ...
    var buttonsFormat = function (value, column, row) {
        ...
        if (row.status == 0 || row.status == 7) {
            if(approvalFlag=="true"){
                return ["<a class='btn-icon icon-edit mr-5' href='${contextPath}/manage/lottery/edit.html?activityId="+ row.activityId +"'>编辑</a>",
                    "<a class='btn-icon icon-detail mr-5' href='${contextPath}/manage/lottery/detail.html?activityId=" + row.activityId + "'>详情</a>",
            ...
            return ["<a class='btn-icon icon-detail mr-5' href='${contextPath}/manage/lottery/detail.html?activityId=" + row.activityId + "'>详情</a>"];
        }
    }
...
//        {name: "usedAmount", text: "中奖人数"},
    ...
    var action = "${contextPath}/manage/lottery/search.html?${_csrf.parameterName}=${_csrf.token}";
    ...
    function init() {
        $("#sure").on("click", function () {
            ...
            $.ajax({
                ...
                url: "${contextPath}/manage/lottery/submitActivityApprovalAjax.html",
                data: {
    ...
    function offShelf(activityId) {
        $.ajax({
            ...
            type: "post",
            url: "${contextPath}/manage/lottery/offshelf.html",
            data: {
                activityId: activityId
            },
    ...
    function onShelf(activityId) {
        $.ajax({
            ...
            type: "post",
            url: "${contextPath}/manage/lottery/onshelf.html",
            data: {
                activityId: activityId
            },
            dataType: "json", //指定服务器的数据返回类型，
