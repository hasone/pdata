...
<head>
    ...
    <meta name="keywords" content="流量平台 分配职位"/>
    <meta name="description" content="流量平台 分配职位"/>
    ...
    <div class="module-header mt-30 mb-20">
        <h3>用户管理
            <a class="btn btn-primary btn-sm pull-right btn-icon icon-back"
               onclick="javascript:window.location.href='${contextPath}/manage/user/index.html?back=1'">返回</a>
        </h3>
    </div>

    <form action="${contextPath}/manage/user/saveUserManager.html" method="post" name="adminForm" id="table_validate">
                ...
                <div class="row form">
                    ...
                    <#else>
                        ...
                        <div class="btn-group btn-group-sm">
                            <input style="width: 0; height: 0; opacity: 0" name="managerId" id="managerId" required>
                            <button type="button" class="btn btn-default" style="width:325px">
                            <#if sc??&&sc=="true">
                                选择用户名称
                            <#else>
                                选择职位名称
                    ...
                    <div class="form-group">
                        <label>用户手机号码：</label>
                        <input type="text" name="mobilePhone" id="mobilePhone" class="hasPrompt" maxLength="11"
                        	onblur="getUserName()" required/>
                    ...
                    <div class="form-group">
                        <label>用户姓名：</label>
                        <input type="text" name="userName" id="userName" class="hasPrompt" maxLength="64" required/>
                        <span style="color:red" id="tip_userName"></span>
                        <div class="prompt">姓名由汉字、英文字符及数字组成，长度不超过64个字符</div>
                    </div>
