...
<#if hasApproval??&&hasApproval=="true">
    ...
    <#if nextPage ==  "false">
        <a href="javascript:void(0)" class="btn btn-sm btn-warning dialog-btn" id="refuse-btn">取消</a>
        <a href="javascript:void(0)" class="btn btn-sm btn-warning dialog-btn" id="submit_approval"
    ...
    <div class="btn-save mt-30" id="second-btn" style="display: none;">
        <a href="javascript:void(0)" class="btn btn-sm btn-warning dialog-btn" onclick="lastStep()"
           id="last-btn">上一步</a>
        <a href="javascript:void(0)" class="btn btn-sm btn-warning dialog-btn" id="refuse1-btn">取消</a>
