...
<#if opinions??>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <span class="detail-value">${(activities.createTime?datetime)}</span>
                    </div>
                    ...
                    <#if activities.type?? && activities.type==2>
                        <div class="form-group">
                    ...
                    <#if activities.type?? && activities.type==8>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span class="detail-value">
                                <#if activityPrize.productSize?? && (activityPrize.productSize<1024)>
                                    ${(activityPrize.productSize)?string("#.##")}KB
                                </#if>
                                <#if activityPrize.productSize?? && (activityPrize.productSize>=1024) && (activityPrize.productSize<1024*1024)>
                                    ${(activityPrize.productSize/1024.0)?string("#.##")}MB
                                </#if>
                                <#if activityPrize.productSize?? && (activityPrize.productSize>1024*1024)>
                                    ${(activityPrize.productSize/1024.0/1024.0)?string("#.##")}GB
                                </#if>
                            </span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="detail-value">${activityPrize.count!}</span>
                        </div>

                        <div class="form-group">
                            <span class="detail-label">已发数量:</span>
                            <span class="detail-value">${activityInfo.givedUserCount!}个</span>
                        </div>

                        <div class="form-group">
                            <span class="detail-label">已发额度:</span>
                            <span class="detail-value">
                                <#if activityInfo?? && activityInfo.usedProductSize?? && activityInfo.usedProductSize lte 1024 && activityInfo.usedProductSize!=0 && activityInfo.usedProductSize!=1024>
                                    ${activityInfo.usedProductSize!} KB
                                </#if>
                                <#if activityInfo?? && activityInfo.usedProductSize?? && activityInfo.usedProductSize gte 1024>
                                    ${(activityInfo.usedProductSize/1024)!} MB
                                </#if>
                                <#if activityInfo?? && activityInfo.usedProductSize?? && activityInfo.usedProductSize==0 >
                                    ${activityInfo.usedProductSize!} MB
                                </#if>
                            </span>
                        </div>
                    </#if>
                ...
                <div class="col-md-6">
                    ...
                    <#if activityInfo.url??>
                        <div class="form-group">
                            <span class="detail-label">红包URL:</span>
                        ...
                        <div class="form-group">
                            <span class="detail-label" style="vertical-align: top;"></span>
                                <span class="detail-value ml-10">
                                    <img src="${contextPath}/manage/redpacket/qrCode.html?activityId=${activities.activityId!}">
                                </span>
                        </div>
                    </#if>
    ...
    <div class="mt-30 text-center">
        <a class="btn btn-sm btn-warning"
           href="${contextPath}/manage/redpacket/records.html?activityId=${activities.activityId!}">查看用户中奖信息</a>
    </div>
</div>
