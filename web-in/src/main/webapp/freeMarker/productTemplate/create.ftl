...
<head>
    ...
    <title>四川流量平台-新增产品模板</title>
    <meta name="keywords" content="四川流量平台 新增产品模板"/>
    <meta name="description" content="四川流量平台 新增产品模板"/>
...
<div class="main-container">
    ...
    <div>
        <div class="mt-30">
            ...
            <h5 class="h5 mt-20">已包含平台产品列表</h5>
            <form>
            ...
            <div class="dataTables_filter text-left">
                <form>
                    <div class="form-inline">
                        <input type="text" id="productIds" name="productIds" class="searchItem hidden"/>
