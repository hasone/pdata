...
<div class="main-container">
	...
	<#if changeTag?? && changeTag==1>
    <div class="module-header mt-30 mb-20">
        <#if authFlag?? && authFlag == "true">
            <#if hasApprovalRecordFlag?? && hasApprovalRecordFlag == "true" && enterStatus?? && enterStatus == "true">
                <a href="${contextPath}/manage/historyEnterprise/index.html?entId=${Enterprises.id!}" class="btn btn-sm btn-danger">
                ...
                <div class="row form">
                    ...
                    <div class="col-md-6">
                        ...
                        <#if Enterprises.startTime??&&Enterprises.endTime??>
                            <div class="form-group" hidden>
                                <label>合作开始时间：</label>
                                <span>${(Enterprises.startTime?datetime)!} ~ ${(Enterprises.endTime?datetime)!}</span>
                        ...
                        <#if crowdfundingFlag>
                            <div class="form-group">
                                <label>众筹方式：</label>
                                <span type="text" name="joinType" id="joinType">
                            ...
                            <#if extEntInfo.joinType?? && extEntInfo.joinType==1>
                                <div class="form-group" style="word-break: break-all;">
                                    <label>回调地址：</label>
                                    <span type="text" name="callbackUrl" id="callbackUrl"> ${(extEntInfo.callbackUrl)!} </span>
                                </div>
                            </#if>
                        </#if>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <#if Enterprises?? && Enterprises.cmEmail??>
                            <div class="form-group" style="word-break: break-all;">
                                <label>客户经理邮箱：</label>
                                <span type="text" name="mobilePhone" id="mobilePhone">${(Enterprises.cmEmail)!}</span>
                            </div>
                        </#if>
                        ...
                        <div class="form-group" id="search-time-range1" hidden>
                        ...
                        <#if enterpriseFile?? && enterpriseFile.customerfileName??>
                            <div class="form-group" hidden>
                                ...
                                >${(enterpriseFile.customerfileName)!}</a>
                            </div>
                        </#if>
                        ...
                        <#if enterpriseFile?? && enterpriseFile.imageName??>
                            <div class="form-group">
                                <label>缴费截图：</label>
                                <a name="image" id="image" onclick="downLoad(this)">${(enterpriseFile.imageName)!}</a>
                            </div>
