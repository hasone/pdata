...
<script>
    ...
    var buttonsFormat = function (value, column, row) {
        return ["<a class='btn-icon icon-down mr-5' href='${contextPath}/manage/enterprise/smsTemplateShow.html?enterId=" + row.id + "'>配置短信模板</a>"];
    }
    ...
    var columns = [{name: "name", text: "企业名称", tip: true, format: nameFormat},
        ...
        {name: "opr", text: "短信模板", format: buttonsFormat}];
