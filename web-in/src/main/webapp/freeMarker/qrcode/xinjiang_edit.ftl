            ...
            <div class="tile-content">
                <div class="row form">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>活动名称：</label>
                            <input type="text" name="name" id="name" value="${activities.name!}" required>
                        </div>

                        <div class="form-group">
                            <label>产品总数：</label>
                            <input type="text" name="prizeCount" id="prizeCount" value="${activityInfo.prizeCount!}"
                                   required>
                    ...
                    <div class="col-md-6">
                            ...
                            <label>活动时间：</label>
                                <span id="activeTime" class="daterange-wrap">
                                    <input type="text" name="startTime" id="startTime"
                                           value="${(activities.startTime?date)!}" readonly="readonly"
                                           style="width: 152px">&nbsp;至
                                    <input type="text" id="endTime" name="endTime" value="${(activities.endTime?date)!}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group btn-group-sm qrcodeSize-select">
                                <input style="width: 0; font-size: 0; height: 0; padding: 0; opacity: 0"
                                       class="form-control searchItem"
                                       name="qrcodeSize" id="qrcodeSize" value="${activityInfo.qrcodeSize!}" required>
                                <button type="button" class="btn btn-default" style="width: 299px">&nbsp;</button>
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                    <span class="caret"></span>
                        ...
                        <div id="searchForm" class="form-inline searchForm" id="table_validate">
                            ...
                            <!--    <div class="form-group form-group-sm">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <input type="text" name="productCode" id="productCode" class="form-control searchItem" autocomplete="off"
                                           placeholder="" value=""
                                           maxlength="255">
                                </div>-->
...
<script>
    ...
    function selectedProduct(id) {
        ...
        if (type == "M") {
            ...
            $("#cmProdSize").removeAttr("readonly");
        }
    ...
    require(["moment", "common", "bootstrap", "daterangepicker", "page/list", "upload"], function (mm) {
        ...
        $("#save-btn").on("click", function () {
                ...
                if (moment(endEle.val() + " 23:59:59").isBefore(today)) {
                    ...
                    if (validator.check(endEle[0])) {
                        ...
                        if (err && err.length) {
                            ...
                            $("#activeTime").parent().append('<span id="endTime-error" class="error error-tip">请选择正确的时间!</span>');
            ...
            if ($("#dataForm").validate().form()) {
                ...
                var cuMobileList = $("#cmMobileList").val();
                var ctMobileList = $("#cmMobileList").val();
    ...
    function getProduct(productId) {
        ...
        $.ajax({
            ...
            url: "${contextPath}/manage/qrcode/getMbProductAjax.html?${_csrf.parameterName}=${_csrf.token}",
            ...
            success: function (res) {
                if (res.success && res.success == "success") {
                    if (res.isp == "M") {
                        ...
                        $("#cmProdSize").val(res.productSize);
