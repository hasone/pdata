...
<div class="main-container">
    ...
    <form id="dataForm" class="form"
          action="${contextPath}/manage/qrcode/save.html?${_csrf.parameterName}=${_csrf.token}"
          method="post"
            ...
            <div class="tile-content">
                <div class="row form">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>活动名称：</label>
                            <input type="hidden" name="name" id="name" value="${activities.name!}"
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="hasWhiteOrBlack" id="hasWhiteOrBlack"
                                   value="${activityInfo.hasWhiteOrBlack!}" required>
                                <span>
                                    <#if activityInfo.hasWhiteOrBlack == 0>无黑白名单</#if>
                                    <#if activityInfo.hasWhiteOrBlack == 1>白名单</#if>
                                    <#if activityInfo.hasWhiteOrBlack == 2>黑名单</#if>
                                </span>
                        </div>
                    </div>
                    ...
                    <#if cqFlag??&&cqFlag==0>
                        ...
                        <div class="form-group">
                            <label style="font-weight:700 ">二维码尺寸：</label>
                            <input type="hidden" name="qrcodeSize" id="qrcodeSize"
                                   value="${activityInfo.qrcodeSize!}"
                                   required>
                                <span>
                                    <#if activityInfo.qrcodeSize == 1>8cm</#if>
                                    <#if activityInfo.qrcodeSize == 2>12cm</#if>
                                    <#if activityInfo.qrcodeSize == 3>15cm</#if>
                                    <#if activityInfo.qrcodeSize == 4>30cm</#if>
                                    <#if activityInfo.qrcodeSize == 5>50cm</#if>
                                </span>
                        </div>
    ...
    <#if cqFlag??&&cqFlag==0>
        ...
        <div class="tile mt-30">
            <div class="tile-header">奖品信息</div>
            <div class="tile-content">
                <div class="">
                    <div class="table-responsive mt-20">
                        <table class="table table-bordered text-center award-table">
                            ...
                            <tr>
                                ...
                                <td>
                                                <span class="cuProdSize" name="cuProdSize"
                                                      id="cuProdSize"
                                                      style="width:80px;">
                                                ${cuProductSize!}
                                                </span>
                                ...
                                <#if cqFlag??&&cqFlag==0>
                                    <td>
                                                <span class="cuProdPrice" name="cuProdPrice"
                                                      id="cuProdPrice"
                                                      style="width:80px;">
                                                ${cuPrice!}
                                                </span>
                            ...
                            <tr>
                                ...
                                <td>
                                                <span class="ctProdSize" name="ctProdSize"
                                                      id="ctProdSize"
                                                      style="width:80px;">
                                                ${ctProductSize!}
                                                </span>
                                ...
                                <#if cqFlag??&&cqFlag==0>
                                    <td>
                                                <span class="ctProdPrice" name="ctProdPrice"
                                                      id="ctProdPrice"
                                                      style="width:80px;">
                                                ${ctPrice!}
                                                </span>
    ...
    <div class="mt-30 text-center">
        <a href="javascript:void(0)" class="btn btn-warning btn-sm mr-10 dialog-btn cancel-btn"
           id="cancel-btn">上一步</a>&nbsp;&nbsp;
...
<script>
    ...
    function updateActivityInfo() {
        ...
        $.ajax({
               ...
               url: "${contextPath}/manage/qrcode/getActivityInfoAjax.html?${_csrf.parameterName}=${_csrf.token}",
               ...
               success: function (res) {
                   ...
                   <#if cqFlag??&&cqFlag==0>
                       activityInfo += res.totalPrice + " 元=》 ";
                   </#if>

                       activityInfo += res.totalSize + " 流量=》 " + res.prizeCount + " 份奖品=》"
                                       + res.userCount + " 个中奖用户";
                   ...
                   <#if cqFlag??&&cqFlag==0>
                       $("#activityInfo").html("0MB 流量=》 0 份奖品=》0 个中奖用户");
                   <#else>
