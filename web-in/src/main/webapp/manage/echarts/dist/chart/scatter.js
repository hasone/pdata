define("echarts/chart/scatter", ["require", "./base", "../util/shape/Symbol", "../component/axis", "../component/grid", "../component/dataZoom", "../component/dataRange", "../config", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
    ...
    return t.prototype = {
        type: a.CHART_TYPE_SCATTER, _buildShape: function () {
            ...
            for (var r in e)if (t = o[r], i = e[r], t.large && t.data.length > t.largeThreshold)this.shapeList.push(this._getLargeSymbol(i, this.getItemStyleColor(this.query(t, "itemStyle.normal.color"), r, -1) || this._sIndex2ColorMap[r])); else for (var s = 0, l = i.length; l > s; s++)n = i[s], a = this._getSymbol(r, n[2], n[3], n[0], n[1]), a && this.shapeList.push(a)
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            for (var u = e("zrender/tool/color"), g = 1 / (this.dataRangeOption.color.length - 1), V = [], U = 0, y = this.dataRangeOption.color.length; y > U; U++)V.push([U * g, this.dataRangeOption.color[U]]);
            ...
            if (this.dataRangeOption.calculable) {
                ...
                "horizontal" == this.dataRangeOption.orient ? (y > p && (p = y), p + o + y > g && (p -= y)) : (l > V && (V = l), V + r + l > U && (V -= l))
            }
