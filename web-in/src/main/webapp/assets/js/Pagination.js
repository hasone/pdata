            ...
            value: function update(data) {
                ...
                if (data.current != undefined) {
                    ...
                    if (params.current > this._calcPage(size, total)) {
                        ...
                        this._changePageSize(size, false);
                        return;
                    }
                }
            ...
            value: function render() {
                ...
                if (pages <= 9) {
                    for (var i = 0; i < pages; i++) {
                        ...
                        pagerList.push(React.createElement(PageItem, {
                            key: i + 1,
                            onClick: this._handleChange.bind(this, i + 1),
                            active: active,
                            currentIndex: i + 1
                        }));
                    }
                    ...
                    for (var _i = 0; _i < end; _i++) {
                        pagerList.push(React.createElement(PageItem, {
                            key: _i + 1, onClick: this._handleChange.bind(this, _i + 1),
                            currentIndex: _i + 1
                        }));
                    }
                    if (edges < interval.start && interval.start - edges != 1) {
                        ...
                        pagerList.push(React.createElement(PageItem, {
                            key: edges + 1, onClick: this._handleChange.bind(this, edges + 1),
                    ...
                    for (var j = interval.start; j < interval.end; j++) {
                        ...
                        pagerList.push(React.createElement(PageItem, {
                            key: j + 1, onClick: this._handleChange.bind(this, j + 1),
                    ...
                    if (interval.end < pages && edges > 0) {
                        if (pages - edges > interval.end && pages - edges - interval.end != 1) {
                            ...
                            pagerList.push(React.createElement(PageItem, {
                                key: interval.end + 1, onClick: this._handleChange.bind(this, interval.end + 1),
                        ...
                        for (var k = begin; k < pages; k++) {
                            pagerList.push(React.createElement(PageItem, {
                                key: k + 1, onClick: this._handleChange.bind(this, k + 1),
                                currentIndex: k + 1
                            }));
                        }
                    }
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        pagerList,
                        React.createElement(PageNext, {
                            current: current,
                            onClick: this._next.bind(this, null),
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "select",
                                {
                                    ...
                                    ref: "pageSize",
                                    onChange: this._selectPageSize.bind(this, null)
                                },
                                React.createElement(
                                    "option",
                                    {value: "10"},
                        ...
                        React.createElement(
                            ...
                            React.createElement("input", {
                                ...
                                onChange: this.goToPage.bind(this, null),
                                type: "text",
                                style: {width: "40px"}
                            }),
                            "页"
