 ...
 */(function (e, t) {
    ...
    if (e.seajs)return;
    var n = e.seajs = {version: "2.1.1"}, r = n.data = {}, s = i("Object"), o = i("String"), u = Array.isArray || i("Array"), a = i("Function"), f = 0, c = r.events = {};
    n.on = function (e, t) {
        var r = c[e] || (c[e] = []);
        return r.push(t), n
    }, n.off = function (e, t) {
    ...
    var r = window, i = document, s = Object.prototype, o = s.toString, u = "body", a = "documentElement", f = "scroll", l = f + "Width", c = f + "Height", h = "ATTRS", p = "PARSER", d = "guid";
    $.extend(BUI, {
    ...
    function t(e) {
        e = e.toLowerCase();
        var t = /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || e.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || [], n = {
            browser: t[1] || "",
            version: t[2] || "0"
        }, r = {};
    ...
    var n = $.UA || function () {
            var n = $.browser || t(navigator.userAgent), r = e(n.version), i = {
                ie: n.msie && r,
                webkit: n.webkit && r,
                opera: n.opera && r,
                mozilla: n.mozilla && r
    ...
    function t(e, n) {
        ...
        e += "";
        var o = 0, u = 0, a = "", f = "", l, c, h = new Date, p = h.getYear(), d = h.getMonth() + 1, v = 1, m = 0, g = 0, y = 0;
    ...
    return e.ATTRS = {
        ...
        __createDom: function () {
            ...
            var e = this, t = e.get("triggerEvent"), n = e.get("triggerHideEvent"), r = e.get("triggerCallback"), i = e.get("triggerActiveCls") || "", s = e.get("trigger"), o = e.get("delegateTrigger"), u = $(s);
    ...
    var t = e("bui/array"), n = e("bui/json"), r = BUI.prefix, i = "data-", s = i + "cfg", o = "PARSER", u = e("bui/component/manage"), a = /-([a-z])/g, f = /^[\{\[]/;
    return y.ATTRS = {
        srcNode: {view: !0},
    ...
    , ["bui/util"], function (e) {
        ...
        return r.ATTRS = {
            ...
            isLoader: !0, _init: function () {
                ...
                var r = this, i = r.get("loadMask"), s = r.get("property"), o = r.get("callback"), u = r.get("renderer"), a = r.get("target");
    ...
    return s.ATTRS = {
        ...
        beforeInit: function () {
            ...
            var r = this, i = r.get("pidField"), s = n.id || n[i], o = r.get("dataProperty"), u = r.findNode(s) || r.get("root");
    ...
    }, {xclass: "message", priority: 0}), s, l = o([{
        text: "\u786e\u5b9a",
    ...
    return n.ATTRS = {highlightedStatus: {value: "hover"}}, t.augment(n, {
        setHighlighted: function (e, t) {
            ...
            if (n.isScrollVertical()) {
                t = t || n.findElement(e);
                var r = n.getScrollContainer(), i = $(t).position().top, s = r.position().top, o = r.height(), u = i - s, a = $(t).height(), f = r.scrollTop();
    ...
    var t = e("bui/common"), n = t.Component.UIBase, r = t.UA, i = e("bui/list/domlist"), s = e("bui/list/keynav"), o = e("bui/list/sortable"), u = t.prefix + "list-item", a = t.Component.View.extend([i.View], {
    ...
    var t = e("bui/common"), n = t.Component, r = n.UIBase, i = n.View.extend([r.ListItemView], {}), s = n.Controller.extend([r.ListItem], {}, {
        ATTRS: {
            elTagName: {
                view: !0,
                value: "li"
            }, xview: {value: i}, tpl: {view: !0, value: "<span>{text}</span>"}
        }
    }, {xclass: "list-item"});
    return s.View = i, s
    ...
    return t.ATTRS = {
        ...
        __bindUI: function () {
            ...
            t.on(e.get("changeEvent"), function (t) {
                var r = e.get("curTrigger"), i = e.get("textField") || r || n, s = e.get("valueField"), o = e.getSelectedValue(), u = !1;
                if (i) {
    ...
    var t = e("bui/common"), n = t.Component, r = e("bui/form/tips").Item, i = e("bui/form/valid"), s = e("bui/form/remote"), o = t.prefix + "form-field-error", u = "data-error", a = n.View.extend([s.View, i.View], {
        ...
        isField: !0, initializer: function () {
            ...
            var e = this, t = e.get("validEvent"), n = e.get("changeEvent"), r = e.get("firstValidEvent"), i = e.getInnerControl();
    ...
    var t = e("bui/common"), n = {
        NORMAL: "normal",
        AJAX: "ajax",
        IFRAME: "iframe"
    }, r = e("bui/form/fieldcontainer"), i = t.Component, s = r.View.extend({
        ...
        renderUI: function () {
            ...
            var n = this, r = n.get("method"), i = n.get("action"), s = n.get("callback"), o = n.get("submitMask"), u = n.serializeToObject(), a, f = t.merge(!0, {
                url: i,
                type: r,
                dataType: "json",
                data: u
    ...
    var t = e("bui/common"), n = t.Component, r = n.UIBase, i = t.prefix, s = i + "menu-item-open", o = "x-caret", u = i + "menu-item-collapsed", a = "data-id", f = n.View.extend([r.ListItemView, r.CollapsableView], {
    ...
    return t.ATTRS = {panelTpl: {}, panelContainer: {}, panelCls: {}}, BUI.augment(t, {
        __renderUI: function () {
            var e = this, t = e.get("children"), n = e._initPanelContainer(), r = e.get("panelCls"), i = r ? n.find("." + i) : n.children();
            BUI.each(t, function (t, n) {
                var r = i[n];
    ...
    var t = e("bui/common"), n = t.Component, r = "tab-item-title", i = "tab-item-close", s = "tab-item-inner", o = "tab-nav-actived", u = "tab-content", a = n.View.extend({
        renderUI: function () {
    ...
    var t = e("bui/common"), n = e("bui/menu"), r = t.Component, i = "tab-nav-list", s = "arrow-left", o = "arrow-right", u = t.prefix + "tab-force", a = "m_close", f = 140, l = r.View.extend({
        renderUI: function () {
        ...
        addTab: function (e, n) {
            ...
            var t = this, n = t._getIndex(e), r = t.getActivedItem(), i = t.get("preItem") || t._getItemByIndex(n - 1), s = t._getItemByIndex(n + 1);
            e.hide(function () {
            ...
            var e = this, t = e.getContentElement().width(), n = e.get("children"), r = e._getTotalWidth(), i = e.get(i);
            ...
            var r = this, t = t || r.getContentElement(), i = t.parent().width(), n = n || t.position(), s = r._getDistanceToBegin(e, n), o = s + r.get("itemWidth") - i;
            return o
    ...
    var t = e("bui/common"), n = e("bui/tab/tabitem"), r = e("bui/tab/panelitem"), i = "bui-tab-item-text", s = t.Component, o = n.View.extend([s.UIBase.Close.View], {
        _uiSetTitle: function (e) {
            var t = this, n = t.get("el"), r = n.find("." + i);
            r.text(e)
        }
    ...
    var t = e("bui/toolbar/bar"), n = BUI.Component, r = n.UIBase.Bindable, i = BUI.prefix, s = "first", o = "prev", u = "next", a = "last", f = "skip", l = "refresh", c = "totalPage", h = "curPage", p = "totalCount", d = [s, o, u, a, f, l], v = [c, h, p], m = t.extend([r], {
        initializer: function () {
    ...
    var t = e("bui/common"), n = e("bui/picker").Picker, r = e("bui/calendar/calendar"), i = t.Date, s = n.extend({
        initializer: function () {
            ...
            if (t.get("showTime")) {
                var s = this.get("lockTime"), o = s && s.hour ? s.hour : r.getHours(), u = s && s.minute ? s.minute : r.getMinutes(), a = s && s.second ? s.second : r.getSeconds();
    ...
    var t = e("bui/common"), n = e("bui/mask"), r = t.UA, i = t.Component, s = e("bui/toolbar"
        ...
        renderUI: function () {
            ...
            var i = this, s = e.get("dataIndex"), o = e.get("cellTpl") || i.get("cellTextTpl"), u = i._getCellInnerText(e, s, n, r);
    ...
    var t = e("bui/common"), n = t.prefix, r = n + "grid-hd-title", i = n + "grid-column-group", s = n + "grid-group-header", o = n + "grid-db-hd", u = function (e) {
        u.superclass.constructor.call(this, e)
    };
    return u.ATTRS = {
        groups: {value: []},
        ...
        renderUI: function (e) {
            var n = this, r = n.get("groups"), u = e.get("header"), a = u.get("el"), f = u.get("children"), l = $('<tr class="' + i + '"></tr>').prependTo(a.find("thead"));
    ...
    var t = e("bui/common"), n = "data-group", r = t.prefix, i = r + "grid-row-group", s = r + "grid-cascade", o = r + "grid-cascade-expand", a = function (e) {
        a.superclass.constructor.call(this, e)
    };
    return a.ATTRS = {groups: {shared: !1, value: []}}, t.extend(a, t.Base), t.augment(a, {
        renderUI: function (e) {
            ...
            var r = this, s = r.get("grid"), o = s.findElement(t), u = s.get("columns").length, a = '<tr class="' + i + '"><td colspan="' + u + '"><div class="bui-grid-cell-inner"><span class="bui-grid-cell-text"><span class="bui-grid-cascade"><i class="bui-grid-cascade-icon"></i></span> ' + e.text + "</span></div></td></tr>", f = $(a).insertBefore(o);
            f.data(n, e)
        }, _getGroupedElements: function (e) {
            var t = this, n = t.get("grid"), r = n.get("view").getAllElements(), i = e.begin, s = e.items.length + i, o = [];
