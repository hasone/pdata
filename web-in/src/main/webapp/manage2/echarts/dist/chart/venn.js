define("echarts/chart/venn", ["require", "./base", "zrender/shape/Text", "zrender/shape/Circle", "zrender/shape/Path", "../config", "../util/ecData", "zrender/tool/util", "../chart"], function (e) {
    ...
    return t.prototype = {
        type: r.CHART_TYPE_VENN, _buildShape: function () {
            ...
            var t, i;
            e[0].value > e[1].value ? (t = this.zr.getHeight() / 3, i = t * Math.sqrt(e[1].value) / Math.sqrt(e[0].value)) : (i = this.zr.getHeight() / 3, t = i * Math.sqrt(e[0].value) / Math.sqrt(e[1].value));
            var n = this.zr.getWidth() / 2 - t, a = (t + i) / 2 * Math.sqrt(e[2].value) / Math.sqrt((e[0].value + e[1].value) / 2), o = t + i;
            0 !== e[2].value && (o = this._getCoincideLength(e[0].value, e[1].value, e[2].value, t, i, a, Math.abs(t - i), t + i));
            var r = n + o, s = this.zr.getHeight() / 2;
            if (this._buildItem(0, 0, n, s, t), this._buildItem(0, 1, r, s, i), 0 !== e[2].value && e[2].value !== e[0].value && e[2].value !== e[1].value) {
                var l = (t * t - i * i) / (2 * o) + o / 2, h = o / 2 - (t * t - i * i) / (2 * o), m = Math.sqrt(t * t - l * l), V = 0, U = 0;
                e[0].value > e[1].value && n + l > r && (U = 1), e[0].value < e[1].value && n + h > r && (V = 1), this._buildCoincideItem(2, n + l, s - m, s + m, t, i, V, U)
            }
            ...
            if (s.pack(r, o[0], e, o[0].data[t], t, o[0].data[t].name), this.shapeList.push(r), o[0].itemStyle.normal.label.show) {
            ...
            var m = this.series, V = m[0], U = this.data[e], d = [U, V], p = this.deepMerge(d, "itemStyle.normal") || {}, c = this.deepMerge(d, "itemStyle.emphasis") || {}, u = p.color || this.zr.getColor(e), y = c.color || this.zr.getColor(e), g = "M" + t + "," + i + "A" + a + "," + a + ",0," + l + ",1," + t + "," + n + "A" + r + "," + r + ",0," + h + ",1," + t + "," + i, b = {
                color: u,
                path: g
            }, f = {
            ...
            f = new o(f), f.buildPathArray && (f.style.pathArray = f.buildPathArray(b.path)), s.pack(f, m[0], 0, m[0].data[e], e, m[0].data[e].name), this.shapeList.push(f)
        }, getCircle: function (e, t, i, n) {
            var o = this.series[0], r = this.data[e], s = [r, o], l = this.deepMerge(s, "itemStyle.normal") || {}, h = this.deepMerge(s, "itemStyle.emphasis") || {}, m = l.color || this.zr.getColor(e), V = h.color || this.zr.getColor(e), U = {
                zlevel: this.getZlevelBase(),
                clickable: !0,
            ...
            return this.deepQuery([r, o, this.option], "calculable") && (this.setCalculable(U), U.draggable = !0), new a(U)
        }, getLabel: function (e, t, i, a) {
            var o = this.series[0], s = o.itemStyle, l = this.data[e], h = [l, o], m = this.deepMerge(h, "itemStyle.normal") || {}, V = "normal", U = s[V].label, d = U.textStyle || {}, p = this.getLabelText(e, V), c = this.getFont(d), u = m.color || this.zr.getColor(e), y = d.fontSize || 12, g = {
                zlevel: r.venn.zlevel + 1,
                style: {x: t, y: i - a - y, color: d.color || u, text: p, textFont: c, textAlign: "center"}
            };
            return new n(g)
        }, getLabelText: function (e, t) {
            var i = this.series, n = i[0], a = n.data[e], o = this.deepQuery([a, n], "itemStyle." + t + ".label.formatter");
            return o ? "function" == typeof o ? o(n.name, a.name, a.value) : "string" == typeof o ? (o = o.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), o = o.replace("{a0}", n.name).replace("{b0}", a.name).replace("{c0}", a.value)) : void 0 : a.name
        }, refresh: function (e) {
