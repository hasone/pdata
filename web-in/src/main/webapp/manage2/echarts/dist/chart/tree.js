define("echarts/chart/tree", ["require", "./base", "zrender/tool/area", "zrender/tool/vector", "../util/shape/Icon", "zrender/shape/Image", "zrender/shape/Line", "zrender/shape/BezierCurve", "../layout/Tree", "../data/Tree", "../config", "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/util", "../chart"], function (e) {
    function t(e, t, n, a, o) {
        i.call(this, e, t, n, a, o), this.refresh(a)
    }

    var i = e("./base"), n = .618, a = (e("zrender/tool/area"), e("zrender/tool/vector"), e("../util/shape/Icon")), o = e("zrender/shape/Image"), r = e("zrender/shape/Line"), s = e("zrender/shape/BezierCurve"), l = e("../layout/Tree"), h = e("../data/Tree"), m = e("../config");
    m.tree = {
        zlevel: 1,
        z: 2,
        calculable: !1,
    ...
    return t.prototype = {
        type: m.CHART_TYPE_TREE, _buildShape: function (e, t) {
            ...
            if ("horizontal" === r)d = (m - l) * o + l, p = h, c = (m - l) * (1 - o) + l, u = V; else if ("radial" === r)if (e.id === this.tree.root.id)d = (m - l) * o + l, p = (V - h) * o + h, c = (m - l) * (1 - o) + l, u = (V - h) * (1 - o) + h; else {
                var y = e.layout.originPosition[0], g = e.layout.originPosition[1], b = t.layout.originPosition[0], f = t.layout.originPosition[1], k = this.tree.root.layout.position[0], x = this.tree.root.layout.position[1];
            ...
            this.tree.traverse(function (e) {
                ...
                if ("horizontal" === i && (o = e.layout.position[0] - s + a, t = e.layout.position[1] + n), "radial" === i) {
