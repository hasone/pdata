    ...
    var MenuItem = function (_Component) {
        ...
        _createClass(MenuItem, [{
            ...
            value: function render() {
                var item = this.props.data,
                    icon = item.customIcon ? React.createElement("i", {className: "menu-icon " + item.customIcon}) : item.icon ? React.createElement(FontIcon, {
                        icon: item.icon,
                        className: "menu-icon"
                    }) : null,
                ...
                var subMenu = children ? React.createElement(SubMenus, {
                ...
                link = link ? React.createElement(
                    "a",
                    {"data-href": link, "data-identity": this.props.identity, onClick: this._onSelect.bind(this)},
                    React.createElement(
                        EnhancedButton,
                        {initFull: true},
                        icon,
            ...
            value: function render() {
                ...
                if (subs) {
                    for (var i = 0; i < subs.length; i++) {
                        ...
                        menus.push(React.createElement(MenuItem, {
                            hasExpand: hasExpand,
                            onSelect: this.props.onSelect,
                            key: i,
                            identity: identity,
